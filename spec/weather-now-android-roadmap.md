...
| ナビゲーション | **Navigation 3（1.0 stable / 2025-11）** | NavigationStack・TCA の StackState に対応 |
...
| テスト | JUnit5 + MockK + Turbine + `runTest` + Roborazzi（スクショ） | Swift Testing + withDependencies に対応 |
